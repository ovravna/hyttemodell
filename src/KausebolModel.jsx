...
const T = {
  no: {
    ...
    verdictOutSub: "hvis du selger etter tiltakene",
    ...
    yearsNote: "Hvor lenge du regner med å eie. Styrer summen av løpende kostnader.",
    prev: "Forrige bilde",
    next: "Neste bilde",
    diy: "Egeninnsats",
  ...
  en: {
    ...
    verdictOutSub: "if you sell once the works are done",
    ...
    yearsNote: "How long you expect to own it. Drives the total of recurring costs.",
    prev: "Previous photo",
    next: "Next photo",
    diy: "Own labour",
  ...
  it: {
    ...
    verdictOutSub: "se vendi dopo gli interventi",
